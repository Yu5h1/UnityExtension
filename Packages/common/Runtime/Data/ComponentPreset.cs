...
namespace Yu5h1Lib
{
    ...
    public class ComponentPreset
    {
        ...
        private ComponentPreset(Component source, string[] memberNames)
        {
        ...
        public static ComponentPreset CopyFrom(Component source, params string[] memberNames)
        {
            if (source == null)
            {
            ...
            return new ComponentPreset(source, memberNames);
        }
        ...
        /// 從 JSON 載入
        /// </summary>
        public static ComponentPreset FromJson(string json)
        {
            try
            {
        ...
        /// 從檔案載入
        /// </summary>
        public static ComponentPreset LoadFromFile(string filePath)
        {
        ...
        private ComponentPreset() { }  // 私有建構子（供 FromJson 用）
    ...
    {
        public static ComponentPreset SavePreset(this Component component, params string[] memberNames)
        {
            return ComponentPreset.CopyFrom(component, memberNames);
        }

        public static bool LoadPreset(this Component component, ComponentPreset preset)
        {
