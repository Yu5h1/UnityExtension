...
namespace Yu5h1Lib.Serialization
{
    ...
    public class DataView : DataView<string, string>
    {
        ...
        private System.StringComparison _comparison = System.StringComparison.OrdinalIgnoreCase;
        protected override bool KeyEquals(string a, string b)
            => a.Equals(b, _comparison);

        public string this[string key, System.StringComparison comparison]
        {
            get
            {
                var original = _comparison;
                _comparison = comparison;
                try { return this[key]; }
                finally { _comparison = original; }
            }
            set
            {
                var original = _comparison;
