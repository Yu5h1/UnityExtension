...
- [preferences.md](skills/preferences.md) — persisting settings with PlayerPrefs: choosing between the UI-binding and typed-value tiers, and wiring `Preferences` in the scene over MCP instead of writing save/load code.
